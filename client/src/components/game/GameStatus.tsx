...
export const GameStatus = (props: Props) => {
  ...
  return (
    <div className="flex items-center justify-between w-40 font-medium">
      <h1
        className={`text-2xl ${
          props.info.homeScore > props.info.awayScore ? "" : "text-gray-400"
        }`}
      >
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        {props.info.status !== "Final" ? (
          <h5 className="font-normal text-gray-400">
            {displayHours(props.info.startTime)}
          </h5>
        ) : (
          <></>
        )}
      ...
      <h1
        className={`text-2xl ${
          props.info.awayScore > props.info.homeScore ? "" : "text-gray-400"
        }`}
      >
